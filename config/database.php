    ...
    */
    ...
    'connections' => [
        ...
        'wbs_ts' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_PMI_TS', '192.168.3.246'),
            'port' => env('DB_PORT_PMI_TS', '3306'),
            'database' => env('DB_DATABASE_PMI_TS', 'forge'),
            'username' => env('DB_USERNAME_PMI_TS', 'forge'),
            'password' => env('DB_PASSWORD_PMI_TS', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
        ...
        'wbs_ts_f3' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_PMI_F3_TS', '192.168.180.11'),
            'port' => env('DB_PORT_PMI_F3_TS', '3306'),
        ...
        'wbs_cn' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_PMI_CN', '192.168.3.246'),
        ...
        'wbs_yf' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_PMI_YF', '192.168.3.246'),
            'port' => env('DB_PORT_PMI_YF', '3306'),
            'database' => env('DB_DATABASE_PMI_YF', 'forge'),
            'username' => env('DB_USERNAME_PMI_YF', 'forge'),
            'password' => env('DB_PASSWORD_PMI_YF', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
