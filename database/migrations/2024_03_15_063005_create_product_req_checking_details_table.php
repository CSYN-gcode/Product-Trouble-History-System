...
class CreateProductReqCheckingDetailsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('p5_prod_req_checking_details', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->foreignId('prod_req_checking_id')->references('id')->on('p5_prod_req_checkings')->comment ='p5_prod_req_checkings (table)';
    ...
    {
        Schema::dropIfExists('p5_prod_req_checking_details');
    }
}
