...
class CreateProductReqCheckingsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('p5_prod_req_checkings', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('prod_visual_insp_name')->nullable();
            $table->string('prod_visual_insp_datetime')->nullable();
            $table->string('prod_visual_insp_result')->nullable();
            $table->unsignedBigInteger('prod_dimension_insp_name')->nullable();
            $table->string('prod_dimension_insp_datetime')->nullable();
            $table->string('prod_dimension_insp_result')->nullable();
            ...
            $table->unsignedTinyInteger('engr_tech_insp_guide_drawing_no')->nullable()->comment = '1 - Checked';
            $table->unsignedTinyInteger('engr_tech_insp_guide_rev_no')->nullable()->comment = '1 - Checked';
            ...
            $table->unsignedBigInteger('engr_tech_visual_insp_name')->nullable();
            $table->string('engr_tech_visual_insp_datetime')->nullable();
            $table->string('engr_tech_visual_insp_result')->nullable();
            $table->unsignedBigInteger('engr_tech_dimension_insp_name')->nullable();
            $table->string('engr_tech_dimension_insp_datetime')->nullable();
            $table->string('engr_tech_dimension_insp_result')->nullable();
            ...
            $table->unsignedTinyInteger('lqc_insp_guide_drawing_no')->nullable()->comment = '1 - Checked';
            $table->unsignedTinyInteger('lqc_insp_guide_rev_no')->nullable()->comment = '1 - Checked';
            ...
            $table->unsignedBigInteger('lqc_visual_insp_name')->nullable();
            $table->string('lqc_visual_insp_datetime')->nullable();
            $table->string('lqc_visual_insp_result')->nullable();
            $table->unsignedBigInteger('lqc_dimension_insp_name')->nullable();
            $table->string('lqc_dimension_insp_datetime')->nullable();
            $table->string('lqc_dimension_insp_result')->nullable();
            ...
            $table->unsignedTinyInteger('process_material_drawing')->nullable()->comment = '1 - Checked';
            $table->string('process_material_drawing_no')->nullable();
            $table->string('process_material_rev_no')->nullable();
            $table->unsignedTinyInteger('process_insp_guide')->nullable()->comment = '1 - Checked';
            $table->unsignedTinyInteger('process_insp_guide_drawing_no')->nullable()->comment = '1 - Checked';
            $table->unsignedTinyInteger('process_insp_guide_rev_no')->nullable()->comment = '1 - Checked';
            ...
            $table->unsignedBigInteger('process_visual_insp_name')->nullable();
            $table->string('process_visual_insp_datetime')->nullable();
            $table->string('process_visual_insp_result')->nullable();
            $table->unsignedBigInteger('process_dimension_insp_name')->nullable();
            $table->string('process_dimension_insp_datetime')->nullable();
            $table->string('process_dimension_insp_result')->nullable();
            $table->string('process_actual_checking_remarks')->nullable();
            ...
            $table->foreign('prod_visual_insp_name')->references('id')->on('tbl_users');
            $table->foreign('prod_dimension_insp_name')->references('id')->on('tbl_users');
            $table->foreign('engr_tech_visual_insp_name')->references('id')->on('tbl_users');
            $table->foreign('engr_tech_dimension_insp_name')->references('id')->on('tbl_users');
            $table->foreign('lqc_visual_insp_name')->references('id')->on('tbl_users');
            $table->foreign('lqc_dimension_insp_name')->references('id')->on('tbl_users');
            $table->foreign('process_visual_insp_name')->references('id')->on('tbl_users');
            $table->foreign('process_dimension_insp_name')->references('id')->on('tbl_users');
    ...
    {
        Schema::dropIfExists('product_req_checkings');
    }
}
